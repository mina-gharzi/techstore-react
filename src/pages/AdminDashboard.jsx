...
export default function AdminDashboard() {
  ...
  // همه‌چیز از روی orders/products/users موجود محاسبه می‌شه، بدون
  // نیاز به هیچ کتابخانه‌ی نمودار خارجی - فقط با CSS/flexbox.
            ...
            >
              {[
                ...
                },
                {
                  ...
                  icon: <ClipboardList size={20} color="#16a34a" />,
                },
                {
